...
function Home() {
  return (
    <div className='h-screen bg-primary relative overflow-x-hidden custom-scrollbar '>
        <img src={require('../assets/images/bg-shape-4.png')} className='h-[60%] w-auto absolute top-20 left-0 opacity-90 z-0'></img>
        <img src={require('../assets/images/bg-shape-3.png')} className='h-[80%] w-auto absolute top-60 -right-64 opacity-90 z-0'></img>
        <CustomNavBar
        ...
        <img src={require('../assets/images/bg-shape-5.png')} className='h-[70%] w-auto absolute top-[600px] left-[200px] opacity-90  z-10'></img>
